...
export default function FlashCard({ subItem, topicName, onReady }: FlashCardProps) {
  const difficultyLabel = ["", "Iniciante", "Básico", "Intermediário", "Avançado", "Expert"][subItem.difficulty] || "Intermediário";
    ...
    >
      ...
      >
        ...
        <p className="text-sm mb-8" style={{ color: "#9494B8" }}>
          Pronto para responder perguntas sobre este conceito?
        </p>
